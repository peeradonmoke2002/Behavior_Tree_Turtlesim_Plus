...
static constexpr char KEYCODE_S_UPPER  = 0x53;  // 'S'
static constexpr char KEYCODE_S_LOWER  = 0x73;  // 's'
static constexpr char KEYCODE_SPACEBAR = ' ';
...
public:
  ...
  int keyLoop()
  {
    ...
    puts("Use G|B|V|C|D|E|R|T keys to rotate to absolute orientations.");
    puts("'F' to cancel a rotation.");
    puts("'S' or spacebar to stop the turtle.");
    puts("'Q' to quit.");
